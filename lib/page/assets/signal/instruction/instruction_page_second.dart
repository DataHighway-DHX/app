...
class InstructionPageSecond extends StatelessWidget {
  ...
  Widget bridgedTokens(Map<String, String> dic, TextStyle bodyText) {
    return Column(
      children: [
        Container(
  ...
  Widget nativeTokens(Map<String, String> dic, TextStyle bodyText) {
    return Column(
      children: [
        Container(
          decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          InstructionTitle(1, dic['signal.pick_token']),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              nativeTokens(dic, bodyText),
              bridgedTokens(dic, bodyText),
            ],
          ),
          SizedBox(height: 50),
          InstructionTitle(2, dic['signal.expected_msb']),
          SizedBox(height: 8),
          Text(
            dic['signal.msb'],
            style: bodyText,
