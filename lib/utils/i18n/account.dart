const Map<String, String> enAccount = {
  ...
  'eth.address.error': 'Ethereum address is invalid',
  'create.name': 'Name',
  ...
  'create.warn7': 'Keep mnemonics in a safe place isolated from any networks',
  'create.warn8':
...
const Map<String, String> zhAccount = {
  ...
  'create.warn6': '离线保存',
  'create.warn7': '将助记符保存在与任何网络隔离的安全位置',
